...
import frc.robot.autonomous.AutoGoBluePath2;
import frc.robot.autonomous.AutoGoBouncePath;
import frc.robot.autonomous.AutoGoDeterminePath;
import frc.robot.autonomous.AutoGoRedPath1;
import frc.robot.autonomous.AutoGoRedPath2;
...
public class RobotContainer {
  ...
  private static Command autoGoDeterminePathCommand;
  private static Command autoGoBluePathCommand;
  private static Command autoGoRedPathCommand;
  private static Command autoGoBluerPathCommand;
  private static Command autoGoRedderPathCommand;
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("Auto Slalom Path", autoGoSlalomPathCommand );
    autoChooser.addOption("Auto Blue Path", autoGoBluePathCommand );
    autoChooser.addOption("Auto Red Path", autoGoRedPathCommand );
    autoChooser.addOption("Auto Barrel", autoGoBarrelPathCommand );
  ...
  private void buildAutonomousCommands() {
    ...
    autoDriveUnitsCommand = new AutoDriveStraightUnits(-0.5, 20.0);
    autoDriveTurnCommand = new AutoTurnToAnglePID(45.0, 0.4).withTimeout(4);
    ...
    autoGoBluerPathCommand = new AutoGoBluePath2(m_driveTrain);
    autoGoRedderPathCommand = new AutoGoRedPath2(m_driveTrain);
    ...
    autoGoDeterminePathCommand = new AutoGoDeterminePath(m_driveTrain);
  ...
  public Command getAutonomousCommand() {
    ...
    //return autoGoDeterminePathCommand;
    ...
    //return autoGoRedderPathCommand;
