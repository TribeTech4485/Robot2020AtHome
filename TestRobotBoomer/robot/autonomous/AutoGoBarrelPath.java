...
/**
 * A complex autonomous command that drives the Barrel path of FRC At Home Challenge
 */
    ...
    addCommands(
      ...
      new AutoDriveStraightTime(-0.75, 3.5), //forward DONE
       ...
       new AutoDriveStraightTime(-0.50, 3.5), //left DONE
        ...
        new AutoSpinToAnglePID(-80.0, 0.50), // turn left 
        new AutoDriveStraightTime(-0.50, 3.5), //left DONE
        new AutoSpinToAnglePID(-75.0, 0.50), // turn left 
        new AutoDriveStraightTime(-0.50, 3.5), //left DONE 

        new AutoSpinToAnglePID(-65.0, 0.50), // turn left 
        new AutoDriveStraightTime(-0.70, 4.75), //forward 
        new AutoSpinToAnglePID(-115.0, 0.50), // turn left 
        new AutoDriveStraightTime(-0.50, 5.0), //left DONE
        new AutoSpinToAnglePID(-20.0, 0.50), // turn left 
        new WaitCommand(1.0), 
        new AutoDriveStraightTime(-0.75, 7.9), //forward DONE
