 ...
 */
public class AutoGoBluePath1 extends SequentialCommandGroup {
   ...
   */
  public AutoGoBluePath1(DriveTrain driveTrain) {
    ...
    addCommands(
        ...
        new AutoDriveStraightTime( -0.6, 1.2)  // go to 2nd ball
