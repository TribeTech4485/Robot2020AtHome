...
/**
 * A complex autonomous command that drives the Blue path in the FRC At Home Challenge
 */
public class AutoGoBluePath2 extends SequentialCommandGroup {
   ...
   public AutoGoBluePath2(DriveTrain driveTrain) {
     ...
     addCommands(
       ...
       new AutoSpinToAnglePID(115, 0.6),        // turn to 2nd ball
       new AutoDriveStraightTime( -0.8, 0.5),  // go to 2nd ball
       new InstantCommand(driveTrain::stop, driveTrain),  new WaitCommand(3.0),
       new AutoSpinToAnglePID(-115, 0.6),       // turn to 3rd ball
